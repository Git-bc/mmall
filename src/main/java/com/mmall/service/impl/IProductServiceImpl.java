...
public class IProductServiceImpl implements IProductService {
    ...
    public ServerResponse saveOrUpdateProduct(Product product) {
        if (product != null){
            ...
            if (product.getId()!= null){
                ...
                return ServerResponse.createBySuccessMessage("产品更新失败");
            }else {
    ...
    public ServerResponse<PageInfo> searchProduct(String productName, Integer productId, int pageNum, int pageSize) {
        ...
        List<Product> productList = productMapper.selectByNameAndProductId(StringUtils.isBlank(productName)?null:productName, productId);
        List<ProductListVo> productListVoList = Lists.newArrayList();
        for (Product productItem : productList) {
            productListVoList.add(assembleProductListVo(productItem));
        }
    ...
    public ServerResponse<PageInfo> getProductByKeywordCategory(String keyword, Integer categoryId, int pageNum, int pageSize, String orderBy) {
        ...
        if (StringUtils.isNotBlank(keyword)){
            keyword = new StrBuilder("%").append(keyword).append("%").toString();
        }
        PageHelper.startPage(pageNum, pageSize);
        //排序处理
